...
import { EncounterParticipantGuard } from '../encounter/encounter-participant/state/encounter-participant.guard';
...
const setupRoutes: Routes = [
  ...
  },
  {
    ...
    canActivate: [DamageTypeGuard, ParticipantGuard, FeatureGuard, ConditionGuard, EncounterParticipantGuard, AuthGuard],
    canDeactivate: [DamageTypeGuard, ParticipantGuard, FeatureGuard, ConditionGuard, EncounterParticipantGuard]
  },
  {
